...
```
cmd/main.go → bot/core, bot/adapter/napcat, bot/adapter/qqofficial, bot/adapter/feishu, bot/adapter/telegram, bot/plugins/*
...
| `gorilla/websocket`              | WebSocket for NapCat / QQ Official adapters |
