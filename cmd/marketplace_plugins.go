...
import (
	...
	plug_checkin "github.com/jeanhua/AniaBot/custom/plugins/checkin"
	...
	plug_pet "github.com/jeanhua/AniaBot/custom/plugins/pet"
	...
	plug_today_partner "github.com/jeanhua/AniaBot/custom/plugins/today-partner"
...
func registerMarketplacePlugins(ania *core.AniaBot) {
	...
	ania.AddPlugin(plug_checkin.NewPlugin())
	...
	ania.AddPlugin(plug_pet.NewPlugin())
	...
	ania.AddPlugin(plug_today_partner.NewPlugin())
